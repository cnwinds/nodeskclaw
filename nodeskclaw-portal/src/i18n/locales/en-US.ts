const enUS = {
  ...
  blackboard: {
    ...
    taskDescriptionPlaceholder: "Task description (supports {'@'}mentions)...",
    createTask: "Create Task",
    priorityLow: "Low",
    priorityMedium: "Medium",
    priorityHigh: "High",
    priorityUrgent: "Urgent",
    taskMentionHint: "Type {'@'} in description to mention members; selecting an AI Employee auto-sets assignee.",
